...
SimpleForm.setup do |config|
  ...
  error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |base|
    base.use :html5
    base.use :placeholder
    base.optional :maxlength
    base.optional :minlength
    base.optional :pattern
    base.optional :min_max
    base.optional :readonly
    base.use :label, class: 'form-control-label'
    base.use :input, class: 'form-control', error_class: 'is-invalid', valid_class: 'is-valid'
    base.use :full_error, wrap_with: { tag: 'div', class: 'invalid-feedback' }
    base.use :hint, wrap_with: { tag: 'small', class: 'form-text text-muted' }
  end
  ...
  error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |base|
    base.use :html5
    base.optional :readonly
    base.wrapper :form_check_wrapper, tag: 'div', class: 'form-check' do |bb|
  ...
  valid_class: 'form-group-valid' do |base|
    base.use :html5
    base.optional :readonly
    base.wrapper :legend_tag, tag: 'legend', class: 'col-form-label pt-0' do |ba|
      ba.use :label_text
    end
    base.use :input, class: 'form-check-input', error_class: 'is-invalid', valid_class: 'is-valid'
    base.use :full_error, wrap_with: { tag: 'div', class: 'invalid-feedback d-block' }
    base.use :hint, wrap_with: { tag: 'small', class: 'form-text text-muted' }
  end
  ...
  config.wrappers :vertical_collection_inline, item_wrapper_class: 'form-check form-check-inline',
   tag: 'fieldset',
  class: 'form-group', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |base|
    base.use :html5
    base.optional :readonly
    base.wrapper :legend_tag, tag: 'legend', class: 'col-form-label pt-0' do |ba|
      ba.use :label_text
  ...
  error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |base|
    ...
    base.optional :readonly
    base.use :label
    base.use :input, class: 'form-control-file', error_class: 'is-invalid', valid_class: 'is-valid'
    base.use :full_error, wrap_with: { tag: 'div', class: 'invalid-feedback d-block' }
    base.use :hint, wrap_with: { tag: 'small', class: 'form-text text-muted' }
  end
  ...
  error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |base|
    ...
    base.optional :step
    base.use :label
    base.use :input, class: 'form-control-range', error_class: 'is-invalid', valid_class: 'is-valid'
    base.use :full_error, wrap_with: { tag: 'div', class: 'invalid-feedback d-block' }
    base.use :hint, wrap_with: { tag: 'small', class: 'form-text text-muted' }
  end
  ...
  error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |base|
    ...
    base.optional :min_max
    base.optional :readonly
    base.use :label, class: 'col-sm-3 col-form-label'
    base.wrapper :grid_wrapper, tag: 'div', class: 'col-sm-9' do |ba|
  ...
  error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |base|
    base.use :html5
    base.optional :readonly
    base.wrapper tag: 'label', class: 'col-sm-3' do |ba|
      ba.use :label_text
    end
    base.wrapper :grid_wrapper, tag: 'div', class: 'col-sm-9' do |wr|
  ...
  valid_class: 'form-group-valid' do |base|
    base.use :html5
    base.optional :readonly
    base.use :label, class: 'col-sm-3 form-control-label'
    base.wrapper :grid_wrapper, tag: 'div', class: 'col-sm-9' do |ba|
  ...
  error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |base|
    base.use :html5
    base.optional :readonly
    base.use :label, class: 'col-sm-3 control-label'
    base.wrapper :grid_wrapper, tag: 'div', class: 'col-sm-9' do |ba|
      ba.wrapper tag:   'div',
  ...
  valid_class: 'form-group-valid' do |base|
    ...
    base.optional :minlength
    base.optional :pattern
    base.optional :min_maxase
    base.optional :readonly
    base.use :label, class: 'sr-only'

    base.use :input, class: 'form-control', error_class: 'is-invalid', valid_class: 'is-valid'
    base.use :error, wrap_with: { tag: 'div', class: 'invalid-feedback' }
    base.optional :hint, wrap_with: { tag: 'small', class: 'form-text text-muted' }
  end
  ...
  error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |base|
    ...
    base.optional :readonly
    base.use :input, class: 'form-check-input', error_class: 'is-invalid', valid_class: 'is-valid'
    base.use :label, class: 'form-check-label'
    base.use :error, wrap_with: { tag: 'div', class: 'invalid-feedback' }
    base.optional :hint, wrap_with: { tag: 'small', class: 'form-text text-muted' }
  end
  ...
  error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |base|
    base.use :html5
    base.optional :readonly
    base.wrapper :form_check_wrapper, tag: 'div', class: 'custom-control custom-checkbox' do |bb|
  ...
  error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |base|
    base.use :html5
    base.optional :readonly
    base.wrapper :form_check_wrapper,
                 tag:   'div',
  ...
  class: 'form-group', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |base|
    ...
    base.use :input, class: 'custom-control-input', error_class: 'is-invalid',
                     valid_class: 'is-valid'
    base.use :full_error, wrap_with: { tag: 'div', class: 'invalid-feedback d-block' }
    base.use :hint, wrap_with: { tag: 'small', class: 'form-text text-muted' }
  end
  ...
  config.wrappers :custom_collection_inline,
                  item_wrapper_class: 'custom-control custom-control-inline', tag: 'fieldset',
  ...
  valid_class: 'form-group-valid' do |base|
    ...
    base.optional :readonly
    base.use :label, class: 'form-control-label'
    base.wrapper :custom_file_wrapper, tag: 'div', class: 'custom-file' do |ba|
  ...
  valid_class: 'form-group-valid' do |base|
    ...
    base.optional :step
    base.use :label, class: 'form-control-label'
    base.use :input, class: 'custom-range', error_class: 'is-invalid', valid_class: 'is-valid'
    base.use :full_error, wrap_with: { tag: 'div', class: 'invalid-feedback d-block' }
    base.use :hint, wrap_with: { tag: 'small', class: 'form-text text-muted' }
  end
  ...
  error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |base|
    base.use :html5
    base.optional :readonly
    base.use :input, class: 'custom-select custom-select-lg', error_class: 'is-invalid',
                     valid_class: 'is-valid'
    base.use :label, class: 'form-control-label'
    base.use :full_error, wrap_with: { tag: 'div', class: 'invalid-feedback' }
    base.use :hint, wrap_with: { tag: 'small', class: 'form-text text-muted' }
